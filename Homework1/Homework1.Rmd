...
# as suplemantary variables using arguments quali.sup and quanti.sup correctly. (3p)
...
```{r}
# f) Show individual plots for the extracted dimensions changing argumennt 
